    ...
    if len(line) > 4:
        for i in range(len(line) - 3):
            if i + 4 < len(line) and np.array_equal(line[i:i + 4], [player] * 4):
                if (i != 0 and line[i - 1] == 0) or line[i + 4] == 0:
                    count_4 += 1
                ...
                """
                if i == 0 and i + 4 < len(line) and line[i + 4] == 0 and line[i + 3] == 0:
                    count_3 += 1
                elif i - 2 >= 0 and line[i - 1] == 0 and line[i - 2] == 0:
                    count_3 += 1
                elif i != 0 and line[i - 1] == 0 and i + 3 < len(line) and line[i + 3] == 0:
                    count_3 += 1
                    """
